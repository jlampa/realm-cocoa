...
public enum Error: ErrorType {
    ...
    /// Error thrown by Realm if the file did already exist when a copy should be written.
    case FileExists

    /// Error thrown by Realm if file was not found when a realm is opened as read-only.
    case FileNotFound
